...
def m(m):
    ...
    markup.add(types.InlineKeyboardButton('Inline Mode', switch_inline_query='TELE KING TEAM'))
    bot.send_message(m.chat.id, 'Hi Welcome Github bot\ncommands : \n/git [username]\n\ncreated By TELE KING TEAM \ndeveloper : @KING_CH', reply_markup=markup)
